...
@Component({
  selector: 'app-ocupacional-3',
  templateUrl: './ocupacional-3.component.html',
  styleUrl: './ocupacional-3.component.scss'
})
export class Ocupacional3Component implements AfterViewInit{
