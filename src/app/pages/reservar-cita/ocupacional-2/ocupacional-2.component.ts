...
@Component({
  selector: 'app-ocupacional-2',
  templateUrl: './ocupacional-2.component.html',
  styleUrl: './ocupacional-2.component.scss'
})
export class Ocupacional2Component implements AfterViewInit{
