...
@Component({
  selector: 'app-psicologia-2',
  templateUrl: './psicologia-2.component.html',
  styleUrl: './psicologia-2.component.scss'
})
export class Psicologia2Component implements AfterViewInit{
