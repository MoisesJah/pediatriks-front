...
@Component({
  selector: 'app-lenguaje-1',
  templateUrl: './lenguaje-1.component.html',
  styleUrl: './lenguaje-1.component.scss'
})
export class Lenguaje1Component implements AfterViewInit{
