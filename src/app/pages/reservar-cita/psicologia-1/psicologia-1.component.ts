...
@Component({
  selector: 'app-psicologia-1',
  templateUrl: './psicologia-1.component.html',
  styleUrl: './psicologia-1.component.scss'
})
export class Psicologia1Component implements AfterViewInit {
