...
@Component({
  selector: 'app-lenguaje-3',
  templateUrl: './lenguaje-3.component.html',
  styleUrl: './lenguaje-3.component.scss'
})
export class Lenguaje3Component implements AfterViewInit{
