...
@Component({
  selector: 'app-ocupacional-1',
  templateUrl: './ocupacional-1.component.html',
  styleUrl: './ocupacional-1.component.scss'
})
export class Ocupacional1Component implements AfterViewInit{
