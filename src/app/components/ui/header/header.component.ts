...
import { TablaSolicitudesComponent } from 'src/app/pages/admin/tabla-solicitudes/tabla-solicitudes.component';
...
export class HeaderComponent implements OnInit {
  ...
  solicituEvent = inject(SolicitudEventService);
  ...
  ngOnInit(): void {
    this.solicituEvent.solicitudProcesada$
